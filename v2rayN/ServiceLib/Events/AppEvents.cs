...
public static class AppEvents
{
    ...
    public static readonly EventChannel<Unit> CoreReloadRequested = new();
    public static readonly EventChannel<ToastNotificationPayload> ToastNotificationRequested = new();
}
