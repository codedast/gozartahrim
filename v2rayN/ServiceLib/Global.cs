...
public class Global
{
    ...
    public const string AppName = "gozartahrim";
    public const string TelegramChannelUrl = "https://t.me/gozartahrim";
    ...
    public static readonly string AvaAssets = $"avares://{AppName}/Assets/";
